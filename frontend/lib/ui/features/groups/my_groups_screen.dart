          ...
          Card(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Your Enrolled Sub-Groups', style: AppTypography.headingMd),
                  const SizedBox(height: AppSpacing.md),
          ...
          FluidTapScale(
            ...
            child: Container(
              ...
              child: const Row(
                ...
                children: [
                  Icon(Icons.add_business, size: 16, color: AppColors.onPrimary),
                  SizedBox(width: AppSpacing.sm),
                  Text('Propose New Contingent Sub-Group', style: AppTypography.buttonMd),
                ],
              ),
            ),
          ),
